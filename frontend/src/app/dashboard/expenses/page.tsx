...
export default function ExpensesPage() {
  ...
  useEffect(() => {  // TODO: Uzyc useefeccta z \[carId]\page.tsx
      ...
      try {
        ...
        const allExp: any[] = user.user.cars.flatMap((car: any) =>
            (car.expenses || []).map((e: any) => ({
              ...
              carId: car.id, // Dodaj ID samochodu dla ułatwienia filtrowania
            }))
        );
        setExpenses(allExp);
    ...
    fetchData();
  }, [refreshTrigger]); // Dodaj refreshTrigger jako zależność
